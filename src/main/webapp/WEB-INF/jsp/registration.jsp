...
<div class="container">
    <div>
        <h2 class="text-center mb-4"><fmt:message key="page.login.title" /></h2>
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-center">
                    <a href="${pageContext.request.contextPath}/registration" class="btn btn-link"><fmt:message key="page.login.register.button" /></a>
                </div>
            </div>
        </div>
    </div>
